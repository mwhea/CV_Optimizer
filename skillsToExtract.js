...
export const skillsToExtract = {
    ...
    */
    ...
    "Databases": { string: ["database", "entity framework"], caseSensitive: ["SQL", " DB"], supersetOf: ["Postgres", "MySQL", "NoSQL"] },
    "Humor": { shortString: ["fun"], string: ["humour", "humor"] },
    "Finance": {regex: [/\bfinance/i]},
    ...
    "Testing": { regex: [/\btest(?:s||ing)/i], string: ["test-driven"], caseSensitive: ["TDD"] },
